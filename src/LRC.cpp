...
static const vector<string> header = {
    ...
    "Style: Default,Arial,16,&H00058DF8,&H00C080FF,&H00FFFFFF,&HFFFFFFFF,0,0,0,0,100.00,100.00,2.00,0.00,2,1.00,1.00,2,0,0,0,134\n",  //
    "\n",                                                                                                                             //
    "[Events]\n",                                                                                                                     //
...
void LRC_TO_ASS::GetOneRow(FILE* fout) {
    ...
    fprintf(fout, "Default,NTP,0000,0000,0000,,");  // 风格、actor、对齐、特效
